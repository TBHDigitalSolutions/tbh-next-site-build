...
description: >
  We audit your current folders, normalize filenames and layers, set export presets, and package everything into a clean, portable structure.
  You get a labeled master bundle, ready-to-share links, and a short usage guide so your team ships faster with fewer handoff issues.
...
deliverables:
  - "Audited inventory and gap list"
  - "Canonical folder tree and naming schema"
  - "Normalized source files (light cleanup)"
  - "Export presets + size matrix"
  - "Batch exports for key variants"
  - "README (2–3 pages) and handoff call"
  - "Delivery as shared folder + ZIP archive"
...
limits:
  ...
  - "Base scope covers one brand and ~100 source files; larger libraries are scoped"

notes: >
  Base scope covers one brand, up to ~100 source files, and 10 export presets. Extended libraries, additional brands, and motion/video
  pipelines are add-ons.
...
faqs:
  ...
  - id: "renaming"
    ...
    answer: "We normalize to the agreed convention and provide an alias map so old names remain discoverable."
  - id: "dam"
...
copy:
  phase1:
    title: "Asset Packaging Kit"
    tagline: "One master bundle, zero guesswork"
  phase2:
    title: "Why you need this"
    tagline: "Clarity, speed, and fewer handoff errors"
  phase3:
    title: "What you get"
    tagline: "Audit, normalization, presets, and handoff"
    includesTitle: "What's included"
    includesSubtitle: "Audit & Plan, Normalize & Organize, Exports & Presets, Documentation & Handoff"
...
extras:
  timelineBlocks:
    - title: "Kickoff & Intake"
      note: "Share current drives and brand kit"
    - title: "Audit & Plan"
      note: "Inventory sources, propose structure & naming (2–3 business days)"
    - title: "Normalize & Export"
      note: "Apply conventions, set presets, batch exports"
    - title: "Package & Deliver"
      note: "Shared folder + ZIP + README; 30-minute walkthrough"
---
...
Create a **trusted, portable master bundle** that any teammate or partner can use without guesswork.
Success looks like a single source of truth, predictable exports for every channel, and fewer back-and-forth
requests at handoff. This approach standardizes structure and naming, preserves license/credit details,
and reduces QA friction so marketing can move at campaign speed.

## Notes

- Base scope: one brand, ~100 source files, up to 10 export presets.  
- We need access to current drives and a brand kit; a single reviewer accelerates decisions.  
- We only package assets you own or have rights to; we do not remove license watermarks.  
- Ongoing hygiene and updates pair well with the **Content Upload Retainer**.

## FAQ

### Can you prep layered files for print too?
Yes. Add the print preset group (PDF/X with bleed & trims) as an add-on.

### Will you manage ongoing uploads?
Use the **Content Upload Retainer** to keep the library current monthly.

### Do you capture license/credit notes?
We preserve embedded metadata when present and add a LICENSE & CREDITS section in the README.

### Can you integrate with our DAM?
Light organization/upload is included. Full DAM taxonomy/workflows can be scoped separately.
