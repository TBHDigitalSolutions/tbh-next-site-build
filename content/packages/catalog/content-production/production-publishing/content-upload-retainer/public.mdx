...
A dependable **publishing engine** for your CMS. We format, QA, and ship your content with clean SEO and accessibility hygiene, maintain a transparent status board, and report on throughput and defects so cadence improves every month.

## Purpose

Turn publishing into a **reliable, standards-driven operation** so finished content ships **on time** with consistent formatting, SEO basics (titles, meta, canonicals, internal links), and a light QA sweep every cycle—freeing your team to focus on **creating**.

## Why this retainer?

Publishing is where great content often stalls—waiting on formatting, links, images, or approvals. This retainer creates **clear lanes, SLAs, and ownership** so everyone knows what's live, what's next, and what's blocked.
...
> Need help writing or planning the content itself? Pair this with **Editorial Calendar Sprint** or **Website Copy Refresh** to keep the pipeline full.

## Notes

- Essential cap covers one brand and standard CMS configurations
- Larger redesigns, new templates, or custom components are out-of-scope
- Complex data/app migrations require separate CMS Migration package
- All work follows accessibility and SEO best practices within platform constraints

## FAQ

### How many items can we publish each month?

The Essential cap covers up to **18 publish actions** or **20 ops hours**—whichever is reached first. Typical teams ship 1–2 posts per week plus a few landing-page updates under this cap.

### What access do you need?

Editor/Admin access to your CMS (staging + production), a shared assets library, and read access to GA4/GSC. We'll also ask for brand and content guidelines.

### Do you do keyword research or longform SEO editing?

This retainer focuses on operational publishing and hygiene. Strategy and longform editing can be added via Content Strategy or SEO packages.

### Do unused hours roll over?

No. We plan capacity to keep cadence consistent. If you routinely under- or over-run the cap, we'll right-size the plan in the monthly review.

### Which platforms do you support?

We regularly publish to **WordPress, Webflow, Contentful, Sanity, HubSpot CMS**, and headless **Next.js** sites with a CMS. Others on request.