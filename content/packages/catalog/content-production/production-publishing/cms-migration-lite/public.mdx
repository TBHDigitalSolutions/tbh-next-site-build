...
# ──────────────────────────────────────────────────────────────────────────────
id: "content-production-cms-migration-lite"
...
description: |
  A focused, low-risk approach to move a small–mid content site between CMSs (e.g., WordPress ⇄ Webflow, Contentful ⇄ Sanity, HubSpot CMS → Next.js/Headless).
  We preserve URLs and metadata, implement redirects, port key templates, and validate analytics so traffic and rankings stay intact.
  You get a repeatable playbook and a safe rollback point.
...
painPoints:
  - "Risk of traffic/ranking loss during CMS change"
  - "Messy redirect maps and legacy URL sprawl"
  - "Inconsistent metadata/canonicals and schema gaps"
  - "Broken images, links, or forms after cut-over"
  - "Unclear rollback or monitoring plan post-launch"
...
outcomes:
  ...
  - "↓ Risk via clear rollback point and migration playbook"

purpose: >
  Execute a parity-first migration that protects organic traffic and site integrity:
  inventory content, map fields, preserve metadata/schema, ship a tested redirect plan, and launch with validation and rollback.
...
deliverables:
  - "Content inventory and parity matrix"
  - "Configured base templates (2) and migrated pages/posts (≤100)"
  - "Redirect map (≤150 rules) with human-readable proofs"
  - "Updated sitemaps/robots and metadata/schema parity"
  - "Validation reports (GA4, Search Console)"
...
notes: >
  For larger sites, multi-brand, i18n, or e-commerce, we’ll scope a Pro migration with expanded inventory, templates, and automation.
...
faqs:
  - id: "rankings"
    question: "Will rankings drop?"
    answer: "Our parity-first approach, redirect proofs, and post-launch sweep minimize risk. Short-term fluctuations can occur; the plan is built to protect and recover."
  - id: "custom-fields"
    question: "Can you migrate custom fields/blocks?"
    answer: "Yes, when both CMSs support compatible structures. We map fields and document any unavoidable gaps."
  - id: "redirects-scale"
    question: "What about complex redirects or many legacy paths?"
    answer: "Add Redirects Pro to automate large maps, test at scale, and monitor post-launch."
  - id: "i18n"
    question: "Do you support multi-language?"
    answer: "Yes—add i18n Starter for language strategy, URL patterns, and hreflang."
  - id: "rollback"
    question: "Is there a rollback plan?"
    answer: "Yes. We prepare and document a safe rollback path and checkpoints before cut-over."
...
copy:
  phase1:
    title: "CMS Migration Lite"
    tagline: "Parity-first, low-risk migration"
  phase2:
    title: "Why you need this"
    tagline: "Protect rankings, links, and analytics"
  phase3:
    title: "What you get"
    tagline: "Inventory, parity, redirects, QA, and launch"
    includesTitle: "What's included"
    includesSubtitle: "Discovery & Planning • Content & Assets • Technical & SEO • QA & Launch"
    highlightsTitle: "Key highlights"
    highlightsTagline: "What makes this safe and effective"
  phase4:
    title: "Details & trust"
...
extras:
  timelineBlocks:
    - title: "Inventory & Plan"
      note: "3–5 business days — crawl, mapping, parity matrix, redirect draft, risk/rollback plan"
    - title: "Migrate & Configure"
      note: "1–1.5 weeks — content/media migration, templates, metadata/schema parity, staging QA"
    - title: "Cut-over"
      note: "Launch window — DNS/hosting switch, sitemaps/robots, GA4/SC validation, redirect proofs"
    - title: "Stabilize"
      note: "24–48h + 14-day warranty — post-launch crawl, fix regressions, final handoff & playbook"
---
...
Protect organic traffic and site integrity during a CMS change by prioritizing **parity** and **governance**: maintain URLs and metadata, implement verifiable redirects, validate analytics and sitemaps, and launch with a documented rollback path and post-launch sweep.
