...
Package your core value into a **scannable, CTA-forward** page your team can send immediately. The goal is a tight hierarchy (headline → value → proof → next step), on-brand visuals that **hold up in print and email**, and an editable master so you can produce future variants without starting from scratch.
...
Scope includes one language and one layout variant (US-Letter or A4). Additional variants, print finishes, and heavy copywriting can be added as options. Turnaround assumes timely feedback within **≤2 business days** per round.
